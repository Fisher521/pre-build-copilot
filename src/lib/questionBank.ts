...
const I18N_QUESTION_BANK: I18nQuestion[] = [
  ...
  // Q3: 产品形态 (MVP)
  {
    ...
    type: 'choice',
    options: [
      { id: 'web', label: { zh: '网页（电脑或手机都能打开）', en: 'Web app (works on desktop & mobile)' }, value: 'web' },
      { id: 'mobile', label: { zh: '手机 App', en: 'Mobile App' }, value: 'ios' },
      { id: 'plugin', label: { zh: '浏览器插件', en: 'Browser Extension' }, value: 'plugin' },
      { id: 'wechat', label: { zh: '微信小程序', en: 'Mini Program / PWA' }, value: 'miniprogram' },
      { id: 'skip', label: { zh: '还没想好', en: 'Not sure yet' }, value: 'unknown' },
    ],
    priority: 3,
    isMVP: true,
  },
